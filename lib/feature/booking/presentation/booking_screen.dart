...
import 'package:movie_app/core/utils/date_time_extension.dart';
import 'package:movie_app/feature/booking/presentation/widget/date_widget.dart';
import 'package:movie_app/feature/booking/presentation/widget/seat_widget.dart';
import 'package:movie_app/feature/booking/presentation/widget/time_widget.dart';
                      ...
                      return SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: List.generate(
                            ...
                            (index) {
                              final time =
                                  TimeOfDay(hour: 10 + (index * 2), minute: 0);
                              return InkWell(
                                onTap: () {
